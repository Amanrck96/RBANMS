...
export const CMS_DEFAULTS: Record<string, { title: string; content: string; imageUrl?: string;[key: string]: any }> = {
  ...
  <p>Our high student-teacher ratio is very advantageous to building a relationship of trust and real engagement with our students. I am indeed very proud of the faculty here being one of the most compassionate I have ever seen in any Institution. Soon after entry, RBANM's Degree college becomes a second home for our students, a safe place for them to discover themselves.</p>
  <p>At RBANM's, we dedicate ourselves to working tirelessly to inspire and guide students towards not just academic achievement, but towards becoming thoughtful, responsible, and empathetic human beings. We believe every student has unique potential, and our role is to help them discover and nurture it in a supportive and encouraging environment.</p>
  <p>We continue to grow, innovate, and improve, constantly seeking to provide our students with the best possible learning experiences and opportunities. I invite you to explore our website, learn more about our programmes, and discover what makes RBANM's a truly special place.</p>
  <p class="font-semibold text-[#800000]">With warm regards,<br/>Director, RBANM's Degree College</p>
</div>`,
