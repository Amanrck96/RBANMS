    ...
    <div className="container mx-auto px-4 py-12 space-y-12">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="bg-white border-2 border-primary">
            <CardContent className="p-6 flex flex-col items-center text-center gap-2">
              ...
              <span className="font-bold text-black">Social Responsibility</span>
            </CardContent>
          </Card>
          <Card className="bg-white border-2 border-primary">
            <CardContent className="p-6 flex flex-col items-center text-center gap-2">
              <Heart className="h-8 w-8 text-primary" />
              <span className="font-bold text-black">Human Empathy</span>
            </CardContent>
          </Card>
          <Card className="bg-white border-2 border-primary">
            <CardContent className="p-6 flex flex-col items-center text-center gap-2">
              <TreePine className="h-8 w-8 text-primary" />
              <span className="font-bold text-black">Environmental Protection</span>
            </CardContent>
          </Card>
          <Card className="bg-white border-2 border-primary">
            <CardContent className="p-6 flex flex-col items-center text-center gap-2">
              <Activity className="h-8 w-8 text-primary" />
              <span className="font-bold text-black">Health Awareness</span>
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <section>
        <Card className="max-w-4xl mx-auto bg-white border-2 border-primary">
          <CardHeader>
            <CardTitle className="text-3xl font-bold text-center text-black">Major Activities</CardTitle>
          </CardHeader>
