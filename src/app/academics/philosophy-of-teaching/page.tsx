  ...
  return (
    <div className="container mx-auto px-4 py-12 md:py-16">
      <Card>
        ...
        <CardContent className="pt-6 prose prose-lg max-w-none text-foreground/80 space-y-6">
          <p>
          ...
          <blockquote className="border-l-4 border-accent pl-6 italic text-foreground/90 relative">
