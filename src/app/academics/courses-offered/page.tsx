...
export default function CoursesOfferedPage() {
  const [data, setData] = useState<{ title?: string; content?: string; tagline?: string; badgeText?: string } | null>(null);
  ...
  useEffect(() => {
    ...
    const docRef = doc(db, 'site-content', 'page-academics-courses');
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4 text-center">
          <Badge variant="secondary" className="mb-4 text-primary font-bold bg-blue-50">
            {data?.badgeText || "Academic Excellence"}
          </Badge>
