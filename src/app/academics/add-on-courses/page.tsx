...
export default function AddOnCoursesPage() {
    const { data, loading } = usePageContent('academics-addon-courses');
    ...
    // Default content definition (lifted from previous render prop)
    ...
    const badgeText = data?.badgeText || "Skill Enhancement";
    const title = data?.title || "Add-on Courses";
    const tagline = data?.tagline || "Enhance your degree with our specialized certification and value-added courses designed to boost employability and skills.";
        ...
        <div className="min-h-screen bg-background pb-12">
            <div className="bg-primary py-16 text-primary-foreground mb-12">
                <div className="container mx-auto px-4 text-center">
                    <Badge variant="secondary" className="mb-4 text-primary font-bold bg-white">{badgeText}</Badge>
