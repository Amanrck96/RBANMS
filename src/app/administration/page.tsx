...
export default function AdministrationPage() {
  // Since Administration isn't strictly a "Department" with tabs, we can use the layout with simple content
  // OR just build a page that looks similar.
  // Using DepartmentLayout is safer for consistency.
